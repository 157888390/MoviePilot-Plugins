...
import { m as makeApiCall, c as categoryColor, p as posterStyle, a as coverUrl, s as statusOf, u as unwrap } from './strm-CfZmxq-8.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-pcqpp-6-.js';

const {toDisplayString:_toDisplayString,normalizeClass:_normalizeClass,createElementVNode:_createElementVNode,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode,createTextVNode:_createTextVNode,renderList:_renderList,Fragment:_Fragment,unref:_unref,normalizeStyle:_normalizeStyle,vModelText:_vModelText,withDirectives:_withDirectives} = await importShared('vue');
...
const _hoisted_16 = { class: "pg-toolbar" };
const _hoisted_17 = { class: "pg-seg" };
const _hoisted_18 = {
  key: 3,
  class: "pg-empty"
};
...
const _hoisted_22 = { class: "pg-info" };
const _hoisted_23 = ["title"];
const _hoisted_24 = { class: "pg-path" };
const _hoisted_25 = { class: "pg-tags" };
const _hoisted_26 = {
  key: 1,
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    ...
    _createElementVNode("div", _hoisted_8, [
      _createElementVNode("div", _hoisted_9, [
        ...
        _cache[5] || (_cache[5] = _createElementVNode("span", null, "媒体总数", -1))
      ]),
      _createElementVNode("div", _hoisted_10, [
        _createElementVNode("b", null, _toDisplayString(overview.value.movie || 0), 1),
        _cache[6] || (_cache[6] = _createElementVNode("span", null, "电影", -1))
      ]),
      _createElementVNode("div", _hoisted_11, [
        _createElementVNode("b", null, _toDisplayString(overview.value.tv || 0), 1),
        _cache[7] || (_cache[7] = _createElementVNode("span", null, "电视剧", -1))
      ]),
      _createElementVNode("div", _hoisted_12, [
        _createElementVNode("b", null, _toDisplayString(overview.value.dir_scraped || 0), 1),
        _cache[8] || (_cache[8] = _createElementVNode("span", null, "已刮削目录", -1))
      ]),
      _createElementVNode("div", _hoisted_13, [
        _createElementVNode("b", null, _toDisplayString(overview.value.unscraped_items || 0), 1),
        _cache[9] || (_cache[9] = _createElementVNode("span", null, "待刮削", -1))
      ])
    ]),
    (categories.value.length)
      ? (_openBlock(), _createElementBlock("div", _hoisted_14, [
          _createElementVNode("button", {
            class: _normalizeClass(['pg-cat', !categoryFilter.value && 'active']),
            onClick: _cache[0] || (_cache[0] = $event => (categoryFilter.value = ''))
          }, [
            _cache[10] || (_cache[10] = _createTextVNode(" 全部 ", -1)),
          ...
          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(categories.value, (cat) => {
            return (_openBlock(), _createElementBlock("button", {
              ...
              class: _normalizeClass(['pg-cat', categoryFilter.value === cat.name && 'active']),
    ...
    _createElementVNode("div", _hoisted_16, [
      _createElementVNode("div", _hoisted_17, [
        _createElementVNode("button", {
          ...
          onClick: _cache[1] || (_cache[1] = $event => (typeFilter.value = 'all'))
        }, [
          _cache[11] || (_cache[11] = _createTextVNode(" 全部 ", -1)),
        ...
        _createElementVNode("button", {
          ...
          onClick: _cache[2] || (_cache[2] = $event => (typeFilter.value = 'movie'))
        }, [
          _cache[12] || (_cache[12] = _createTextVNode(" 电影 ", -1)),
        ...
        _createElementVNode("button", {
          ...
          onClick: _cache[3] || (_cache[3] = $event => (typeFilter.value = 'tv'))
        }, [
          _cache[13] || (_cache[13] = _createTextVNode(" 电视剧 ", -1)),
    ...
    (loading.value)
      ? (_openBlock(), _createElementBlock("div", _hoisted_18, "正在扫描监控目录…"))
      : (!visibleItems.value.length)
        ? (_openBlock(), _createElementBlock("div", _hoisted_19, "没有匹配的媒体"))
              ...
              return (_openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode("div", _hoisted_22, [
                  _createElementVNode("div", {
                    class: "pg-title",
                    title: item.path
                  }, _toDisplayString(item.title), 9, _hoisted_23),
                  _createElementVNode("div", _hoisted_24, _toDisplayString(item.path), 1),
                  _createElementVNode("div", _hoisted_25, [
                    ...
                    (item.type === 'tv')
                      ? (_openBlock(), _createElementBlock("span", _hoisted_26, _toDisplayString(item.total_episodes || item.total_files) + " 集 · " + _toDisplayString((item.seasons || []).length) + " 季", 1))
                      : (item.multi_version)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_27, _toDisplayString(item.total_files) + " 版本", 1))
                        : (_openBlock(), _createElementBlock("span", _hoisted_28, "单版本")),
                    (item.unscraped)
                      ? (_openBlock(), _createElementBlock("span", _hoisted_29, _toDisplayString(item.unscraped) + " 待刮", 1))
                      : (_openBlock(), _createElementBlock("span", _hoisted_30, "已刮削"))
                  ])
                ])
              ]))
            }), 128))
          ])),
    _cache[14] || (_cache[14] = _createElementVNode("div", { class: "pg-foot" }, " 分类分组按监控目录下的一级子目录自动识别，可在此按分类筛选； 按分类刷新、单集/版本重刮与刮削记录请使用左侧导航的「STRM 刮削」页面。 ", -1))
  ]))
}
}

};
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-8f121c28"]]);
